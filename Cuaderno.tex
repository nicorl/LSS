...
\usepackage{fancyhdr}
\usepackage{float}
\usepackage{titlesec} % para cambiar el /part de estilo
...
%paginas pares e impares HEAD
\lhead[x1]{x2}
\chead[y1]{y2}
\rhead[z1]{z2}
\renewcommand{\headrulewidth}{0.5pt}

%paginas pares e impares FOOT
\lfoot[a1]{b2}
\cfoot[c1]{d2}
\rfoot[e1]{f2}
\renewcommand{\footrulewidth}{0.5pt}

%pagina inicial capitulo
...
%	\renewcommand{\footrulewidth}{0.5pt}
%}
%encabezados y pies de página% fin
